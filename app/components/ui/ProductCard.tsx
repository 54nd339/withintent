...
export function ProductCard({ product, index, whatsAppNumber = '919876543210' }: Props) {
  const [isHovered, setIsHovered] = useState(false);

  const mainImage = product.mainImage?.url;
  const hoverImage = product.galleryImages?.[0]?.url || mainImage;
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-start">
        ...
        <span className="font-sans text-sm font-medium text-neutral-900 dark:text-neutral-100">
