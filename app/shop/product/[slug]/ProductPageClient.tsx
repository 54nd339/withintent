...
import { useShare, useImageCarousel } from '@/hooks';
...
export default function ProductPageClient({ globalSettings, product }: ProductPageClientProps) {
  ...
  const { allImages, currentImage, currentImageIndex, nextImage, prevImage, goToImage } = 
    useImageCarousel(product.mainImage, product.galleryImages, product.slug);
      ...
      <div className="min-h-screen pt-20 sm:pt-24 md:pt-28 pb-8 sm:pb-10 md:pb-12 lg:pb-16">
        <div className={`${RESPONSIVE_PADDING} max-w-7xl mx-auto`}>
          ...
          <div className="flex flex-col lg:flex-row gap-8 sm:gap-10 md:gap-12 lg:gap-16">
            {/* Image Section */}
            <div className="relative flex-1 bg-neutral-100 dark:bg-neutral-800 min-h-[400px] lg:min-h-[600px] rounded-lg overflow-hidden">
              {currentImage && (
                <>
                  <Image
            ...
            <div className="flex-1 lg:max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mb-8">
                <button
                  ...
                  disabled={isSold}
                  className={`flex-1 px-8 py-3 text-sm uppercase tracking-widest transition-colors text-center ${
                    isSold
